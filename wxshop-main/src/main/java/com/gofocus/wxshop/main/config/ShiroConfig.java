package com.gofocus.wxshop.main.config;

import com.gofocus.wxshop.main.service.VerificationCodeCheckService;
import com.gofocus.wxshop.main.shiro.ShiroRealm;
...
/*    @Bean
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager, ShiroLoginFilter shiroLoginFilter) {
        ...
        patterns.put("/api/v1/order", "anon");
        patterns.put("/**", "authc");
